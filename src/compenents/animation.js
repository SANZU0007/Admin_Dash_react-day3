    ...
    return (
        <div className="base-div">
            ...
            <div className="animation-div">
                <p className="ani-title">Animation Utilities</p>
                <p className="ani-content">Bootstrap's default utility classes can be found on the official Bootstrap Documentation page.
                 ...
                 <div className="ani">
                    <div className="ani-first">
                        <p className="ani-first-title">Grow In Animation Utilty</p>
                        <p className="fade">.animated--grow-in</p>
                        <p><small>Navbar Dropdown Example:</small></p>
                        <div className="ani-dropdown">
                            <h3>Navbar</h3>
                            <select>
                        ...
                        <p className="ani-first-content">Note: This utility animates the CSS transform property, meaning it will override any existing transforms on an element being animated! 
                        In this theme, the grow in animation is only being used on dropdowns within the navbar.</p>
                    </div>
                    <div className="ani-second">
                        <p className="ani-first-title">Fade In Animation Utilty</p>
                        <p className="fade">.animated--fade-in</p>
                        <p><small>Navbar Dropdown Example:</small></p>
                        <div className="ani-dropdown">
                            <h3>Navbar</h3>
                            <select>
                        ...
                        <p><small>Navbar Button Example:</small></p>
