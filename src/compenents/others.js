        ...
        <div className="menu">
          ...
          <div className="nav">
            ...
            <div className="others-div">
              <p className="other-title ani-title">Other Utilities</p>
              <p className="other-content ani-content">
              ...
              <div>
                <p className="rotate-first">.rotate-15</p>
                <p className="rotate-second">.rotate-n-15</p>
              </div>
            </div>
          </div>
        </div>
