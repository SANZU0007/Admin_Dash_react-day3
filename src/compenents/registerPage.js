              ...
              <span id="search-icon">
                ...
                <img src="https://png.pngtree.com/png-vector/20190321/ourmid/pngtree-vector-users-icon-png-image_856952.jpg" />
                        ...
                        <div className="register-page">
                            <h4 className="login-tile">Create an Account</h4>
                            <div className="register">
                                <div className="names">
                                    <input type="text" placeholder="First Name" />
                                    <input type="text" placeholder="Last Name" />
                                </div>
                                <input type="email" placeholder="Email Address" className="email-inp" />
                                <div className="pass-field">
                                    <input type="password" placeholder="Password" />
                                    <input type="password" placeholder="Repeat Password" />
                                </div>
                                <button className="login-btn">Register Account</button>
