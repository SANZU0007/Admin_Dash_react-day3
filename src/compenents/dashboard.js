      ...
      <div className="inner-div">
        <div className="menu">
          <div className="left-menu">
            <h4 className="h4">
              <i class="fa-sharp fa-solid fa-face-smile smile"></i>
              <span>
                SB ADMIN <sup>2</sup>
              </span>
            </h4>
            ...
            <div className="interfaces">
              ...
              <h4 onClick={change} className="settings">
              ...
              <div className="inter-parent">
                <div className="components">
                  {show && (
                    <div className="components-child">
                      <p>Custom components</p>
                      <button onClick={() => navigate("/buttons")}>
                        Buttons
                      </button>
              ...
              <div className="utilities settings">
                <h4 onClick={changing}>
                  <i class="fa-solid fa-wrench wrench"></i>utilities
                  <i class="fa-solid fa-angle-right angle2"></i>
                </h4>
                <div className="inter-parent2">
                  <div className="components">
                    {show2 && (
                      <div className="components-child utility-comp">
                        <p>Custom utilities</p>
                        <button onClick={() => navigate("/colors")}>
                          Colors
                        </button>
                        <button onClick={() => navigate("/borders")}>
                          Borders
                        </button>
                        <button onClick={() => navigate("/animation")}>
                          Animations
                        </button>
                        <button onClick={() => navigate("/others")}>
                          Others
                        </button>
                      </div>
                    )}
            ...
            <div className="add-ons">
              ...
              <div className="utilities settings add-on-utility">
                <h4 onClick={changing2}>
                  <i class="fa-solid fa-wrench wrench"></i>Pages
                  <i class="fa-solid fa-angle-right angle3"></i>
                </h4>
                <div className="inter-parent2">
                  <div className="components">
                    {show3 && (
                      <div className="components-child ch2">
                        <p>Custom utilities</p>
            ...
            <div className="nav-search">
              ...
              <div className="account">
                <span id="search-icon">
                  ...
                  <img
                    id="gmail"
                    src="https://cdn-icons-png.flaticon.com/128/888/888853.png?ga=GA1.1.528114384.1693122553&track=aisg"
                  ></img>
                </span>
              ...
              <div className="earnings">
                <div className="first">
                  <div className="first-inside">
                    <p className="type">EARNINGS (MONTHLY)</p>
                    <p className="amount">$40,000</p>
                  </div>
                  <div>
                    <i class="fa-sharp fa-solid fa-suitcase case"></i>
                  </div>
                </div>
                <div className="second">
                  <div className="second-inside">
                    <p className="type-two">EARNINGS (ANNUAL)</p>
                    <p className="amount">$215,000</p>
                  </div>
                  <div>
                    <i class="fa-sharp fa-solid fa-dollar-sign case"></i>
                  </div>
                </div>
                <div className="third">
                  <div className="third-inside">
                    <p className="type-three">TASKS</p>
                ...
                <div className="four">
                  <div className="four-inside">
                    <p className="type-four">PENDING REQUESTS</p>
                    <p className="amount">50%</p>
                  </div>
                  <div>
                    <i class="fa-solid fa-comments comment"></i>
                  </div>
                </div>
              </div>
            </div>
