...
function Cards(){
    ...
    return (
        <div className="base-div">
            ...
            <div className="menu">
            <div className="left-menu card-left">
            ...
            <div className="earnings">
                ...
                <div className="card-content">
                    ...
                    <div className="content-two">
                        ...
                        <p>Dropdown menus can be placed in the card header in order to extend the functionality of a basic card. 
                            In this dropdown card example, 
